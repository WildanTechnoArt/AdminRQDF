...
import com.wildan.adminrqdf.presenter.LoginPresenter
import com.wildan.adminrqdf.utils.UtilsConstant.PLAY_SERVICES_RESOLUTION_REQUEST
...
class LoginActivity : AppCompatActivity(), LoginView.View {
    ...
    private fun prepare() {
        ...
        GlideApp.with(this)
            .load(R.drawable.blue_sampul_rqc)
            .into(img_logo)
